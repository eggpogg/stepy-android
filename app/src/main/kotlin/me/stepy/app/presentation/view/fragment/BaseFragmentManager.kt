...
class BaseFragmentManager(manager: FragmentManager, val layoutId: Int) {
    ...
    private fun popEveryFragment() {
        ...
        (0..backStackCount - 1).map { _manager.getBackStackEntryAt(it).id }
                .forEach { _manager.popBackStack(it, FragmentManager.POP_BACK_STACK_INCLUSIVE) }
    }
